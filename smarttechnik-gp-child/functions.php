...
wp_script_add_data( 'smarttechnik-main', 'strategy', 'defer' );

}
add_action( 'wp_enqueue_scripts', 'smarttechnik_child_enqueue_scripts', 20 );

/**
 * Dodaje preconnect i preload do nagłówka.
 */
function smarttechnik_preloads() {
    ?>
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <!-- Preload przykładowego hero image (zmień ścieżkę na lokalną WebP) -->
    <link rel="preload" as="image" href="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/img/hero.webp' ); ?>" imagesrcset="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/img/hero.webp' ); ?>" fetchpriority="high">
    <?php
}
add_action( 'wp_head', 'smarttechnik_preloads' );
