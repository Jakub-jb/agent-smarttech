...
<header class="site-header" role="banner">
  <div class="container header-inner">
    ...
    <button class="burger" type="button" aria-label="Navigation umschalten" aria-expanded="false" aria-controls="mobile-menu">
  ...
  <nav id="mobile-menu" class="mobile-nav" aria-label="Mobile Hauptnavigation" hidden>
    <?php
    wp_nav_menu(
        array(
            'theme_location' => 'primary',
